...
// DefaultProtocolName — имя, под которым в реестре живёт протокол, опубликованный
// без имени (PRT-21). Зеркалит платформу: нужно, чтобы сличать записи манифеста
// с перечнем протоколов реестра — пустое имя записи и есть это имя.
const DefaultProtocolName = "default"
