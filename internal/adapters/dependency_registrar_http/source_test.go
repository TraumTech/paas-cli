...
func TestRegisterDependency_SendsSnapshotAndMapsResult(t *testing.T) {
	...
	dependency, err := src.RegisterDependency(context.Background(), svcID, verID, prodID, []byte(contract), nil, false)
	require.NoError(t, err)
...
func TestRegisterDependency_SupersedePreviousInBody(t *testing.T) {
	...
	_, err := src.RegisterDependency(context.Background(), svcID, verID, prodID, []byte(contract), nil, true)
	require.NoError(t, err)
...
func TestRegisterDependency_SendsMethods(t *testing.T) {
	...
	_, err := src.RegisterDependency(context.Background(), svcID, verID, prodID, []byte(contract), []string{"GET /x", "POST /y"}, false)
	require.NoError(t, err)
...
func TestRegisterDependency_OmitsEmptyMethods(t *testing.T) {
	...
	_, err := src.RegisterDependency(context.Background(), svcID, verID, prodID, []byte(contract), nil, false)
	require.NoError(t, err)
...
func TestRegisterDependency_InvalidServiceID(t *testing.T) {
	...
	_, err := src.RegisterDependency(context.Background(), "not-a-uuid", verID, prodID, []byte(contract), nil, false)
	require.Error(t, err)
}
...
func TestRegisterDependency_InvalidVersionID(t *testing.T) {
	...
	_, err := src.RegisterDependency(context.Background(), svcID, "not-a-uuid", prodID, []byte(contract), nil, false)
	require.Error(t, err)
}
...
func TestRegisterDependency_InvalidProducerID(t *testing.T) {
	...
	_, err := src.RegisterDependency(context.Background(), svcID, verID, "not-a-uuid", []byte(contract), nil, false)
	require.Error(t, err)
}
